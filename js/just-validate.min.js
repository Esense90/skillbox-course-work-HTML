...
function(e) {
  ...
  f.prototype = {
    ...
    defaultMessages: { required: "Недопустимый формат!", email: "Введите корректный эмейл!", maxLength: "Недопустимый формат!", minLength: "Недопустимый формат!", password: "Password is not valid", remote: "Адрес электронной почты уже существует!", strength: "Password must contents at least one uppercase letter, one lowercase letter and one number", "function": "Недопустимый формат!" },
